...
**实测结果（2026-09-21）**：批 1 → host **903 (failed: 0)**（U1–U6 绿，红相 **10**）· 批 2 → host **920 (failed: 0)**（U7–U11 绿，红相 **21**）· 批 3 → client **257 (failed: 0)**（U12–U14 绿，红相 **27** 与 **7**），host 仍 **920**。**真机**：侧栏入口已在 3080 页面渲染（owner 截图，宽态）。**未闭合**：真机复验点 1（三头 curl 重放）与点 3 的收起 / 标题栏两态。
