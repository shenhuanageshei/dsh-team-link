 ...
 * field: the two writers that consume it (`migrateLegacyPolicy`,
 * `adoptMemoryWindow`) both used a five-field subset before, which is exactly
 * how a namespace holding a roster could still read as "at defaults" and then be
 * overwritten by a migration payload that carries no `teams` at all. Fields
 * added to {@link DEFAULT_POLICY} belong here in the same change.
 */
